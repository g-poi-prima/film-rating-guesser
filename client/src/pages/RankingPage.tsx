    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      {ranking.length === 0 && (
        <div className="text-center py-12 text-gray-500">
          <p>Nessun punteggio ancora registrato. Gioca per apparire in classifica!</p>
        </div>
      )}
      ...
      <div className="space-y-3">
        {ranking.map((entry, index) => {
          return (
            <div
              key={entry.id}
              className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-4 flex items-center gap-4 transition-all hover:shadow-md"
            >
