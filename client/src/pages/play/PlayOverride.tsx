    ...
    <div style={{
      ...
      <div style={{
        ...
        {movie && !showResult && !loading && (
          <div style={{ flex: 1, minHeight: 0, display: 'flex', gap: 36 }}>

            {/* LEFT — poster with HUD frame */}
            <div style={{ width: 280, flexShrink: 0, display: 'flex', flexDirection: 'column' }}>
              <div style={{ flexShrink: 0, display: 'flex', justifyContent: 'space-between', marginBottom: 10 }}>
            ...
            <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column' }}>
              ...
              <h1 style={{
                ...
                fontSize: Math.max(36, Math.min(72, 72 - Math.max(0, movie.title.length - 16) * 1.1)),
                lineHeight: 0.9, letterSpacing: -1, textTransform: 'uppercase', color: C.text,
              ...
              {/* overview fills space, clips if too long */}
              <p style={{
                flex: 1, minHeight: 0,
                margin: '16px 0 0', fontSize: 14, lineHeight: 1.6, color: C.textMuted, maxWidth: 520,
                overflow: 'hidden',
              }}>
                {movie.overview}
              </p>

              {/* rating console — anchored to bottom */}
              <div style={{ flexShrink: 0, paddingTop: 20 }}>
                <HudPanel accent={C.cyan} glow style={{ padding: 20, background: C.surface2 }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
                      <span style={{
                        fontFamily: FONT_DISPLAY, fontWeight: 800,
                        fontSize: 80, lineHeight: 0.86, letterSpacing: -1,
                        color: C.cyan,
                    ...
                    <button
                      ...
                      style={{
                        background: C.cyan, color: C.stage, border: 0,
                        padding: '12px 22px', clipPath: cutCorners(8),
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                  <span style={{
                    fontFamily: FONT_DISPLAY, fontWeight: 800,
                    fontSize: 200, lineHeight: 0.82, letterSpacing: -6,
                ...
                <h2 style={{
                  ...
                  fontSize: 40, lineHeight: 1, letterSpacing: -0.5, textTransform: 'uppercase',
                  color: C.text,
                }}>
                ...
                <p style={{ maxWidth: 420, marginTop: 12, fontSize: 14, color: C.textMuted, lineHeight: 1.6 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                ...
                <button
                  ...
                  style={{
                    background: C.cyan, color: C.stage, border: 0,
                    padding: '14px 20px', clipPath: cutCorners(10),
